<template>
  <div>
    ...
    <div class="text-xl space-y-4 text-justify">
      ...
      <img
        class="shadow-xl/50 block mx-auto md:float-left md:mr-6 mb-4 md:mb-0 h-64 md:h-72 rounded-2xl"
        src="../assets/img/uni-start.jpg"
      />

      <p>
        At the same time, I started university. As part of my apprenticeship, I was going to
        university on Mondays and working at Kainos for the rest of the work week. In order to get
        uni coursework done, and avoid burning out at work, I had to develop careful time management
        skills.
      </p>
      ...
      <p>
        I enjoy messing about with technology. The related image for this section shows the 3DS that
        I hacked in order to run custom firmware. I also enjoy learning how computers work. When I
        have time, I enjoy learning Linux, experimenting with different programming languages, etc.
      </p>
